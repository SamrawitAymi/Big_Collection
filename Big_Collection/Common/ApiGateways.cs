...
namespace Big_Collection.Common
{
    public class ApiGateways
    {
        public static class ApiGateway
        {
            ...
            public const string PRODUCTS_API_BASEURL = GATEWAY + "/product/";// =  https://localhost:44341/api/products/{catchAll}
            ...
            public const string ALL_PRODUCTS = PRODUCTS_API_BASEURL + "getall/";
